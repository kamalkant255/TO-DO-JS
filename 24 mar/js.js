...
function minimize(e){
    let box = e.target.closest(".box");
    console.log(box);
    let textAreakaMain=box.querySelector('main');
    console.log(textAreakaMain);
    if(textAreakaMain.style.display!=="none"){
        textAreakaMain.style.display="none"
    }else{
        textAreakaMain.style.display="flex"
    }
